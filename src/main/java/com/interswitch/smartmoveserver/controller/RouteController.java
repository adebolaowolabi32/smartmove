...
public class RouteController {
    ...
    private Iterable<Route> find(@Validated @PathVariable Enum.TransportMode type) {
        return routeService.find(type);
    }

    @GetMapping(value = "/findByOwner/{owner}", produces = "application/json")
    private Iterable<Route> findByOwner(@Validated @PathVariable long owner) {
