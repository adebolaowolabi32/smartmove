...
public class TerminalController {
    ...
    private Iterable<Terminal> getAll() {
    ...
    private Iterable<Terminal> find(@Validated @PathVariable Enum.TransportMode type) {
        return terminalService.find(type);
    }

    @GetMapping(value = "/findByOwner/{owner}", produces = "application/json")
    private Iterable<Terminal> findByOwner(@Validated @PathVariable long owner) {
