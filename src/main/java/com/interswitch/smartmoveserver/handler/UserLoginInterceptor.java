...
public class UserLoginInterceptor extends HandlerInterceptorAdapter {
    ...
    private static List<String> excludedEndpoints = Arrays.asList("/", "/error.*", "/login", "/auth/login", "/api/.*", "/signup/?", "/smlogout/?", "/index/?", "/assets/.*", "/css/.*", "/fonts/.*", "/images/.*", "/img/.*", "/js/.*", "/sass/.*", "/scss/.*", "/vendor/.*");
