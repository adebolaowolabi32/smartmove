...
public class UserLoginInterceptor extends HandlerInterceptorAdapter {
    ...
    private static List<String> excludedEndpoints = Arrays.asList("/","/error.*", "/auth/login","/api/.*","/signupnew","/forgotpassword","/login","/signup/?", "/smlogout/?", "/index/?", "/assets/.*", "/css/.*", "/fonts/.*", "/images/.*", "/img/.*", "/js/.*", "/sass/.*", "/scss/.*", "/vendor/.*");
